...
Department::Department(const Department& other) 
    : name(other.name), disciplineCount(other.disciplineCount), 
      disciplineCapacity(other.disciplineCapacity), teacherCount(other.teacherCount),
...
Department::Department(Department&& other) noexcept
    ...
    other.teacherCount = 0;
    other.teacherCapacity = 0;
}
